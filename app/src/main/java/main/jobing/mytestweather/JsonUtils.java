...
public class JsonUtils {
    ...
    public static void parseCurrentWeatherJson(String resultJson) {
        ...
        System.out.println("JSON длина строки = " + resultJson.length());
        JSONObject weatherJsonObject = null;
        try {
            weatherJsonObject = new JSONObject(resultJson);
    ...
    public static String convertJsonToCsv(String jsonString) {
        ...
        String stResString = null;
        try
        {
            jsonObject = new JSONObject(jsonString);
            stResString = CDL.toString(jsonObject.getJSONArray("weather"));
        }
        catch (Exception ex)
        {
